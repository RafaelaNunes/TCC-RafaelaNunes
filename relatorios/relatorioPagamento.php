...
<?php 
	...
	$sql = "SELECT * FROM  idtipopagamento WHERE idobra ='".$idobra."' ";
...
<form action="relatorioPagamento_script.php" method="POST">

	 		<H1 class="tituloRelatorio">Selecione o metodo de pagamento </H1>
          
          
           <input type="hidden" name=idobra value="<?php echo $idobra; ?>"/>

  <select name="pagamento" class="opcao">
