...
<?php 
echo "<br><br>";
echo " <h1 class='tituloRelatorio'> Relatorio do produto  $produto</h1>" ;
 ...
 ?>
	...
	$sql = "SELECT idproduto , idcategoria FROM produto WHERE nome ='".$produto."' ";
$dados = mysqli_query($conexao, $sql);

 while ($linha = mysqli_fetch_assoc($dados)) {
 $idresgatado=$linha['idproduto'];
 $idCategoriaresgatado=$linha['idcategoria'];

/* pegar o nome da categoria */ 
$sql2 ="SELECT nome FROM categoria WHERE idcategoria ='$idCategoriaresgatado' AND idobra = '$idobra' ";
...
// faz a soma por categoria
	$query2 = "SELECT  nome, SUM(valor)  FROM material WHERE nome = '$produto' AND idproduto ='$idresgatado' AND idobra = '$idobra' ";
 ...
 //soma total
$query = "SELECT  SUM(valor) FROM material WHERE nome = '$produto' AND idobra = '$idobra'" ;
...
<div class="divAdd"><?php echo "<a href ='relatorioProduto.php?idobra=$idobra' class='linkAdd'> Voltar</a> <br> "; ?></div>
</body>
</html>
